...
public class TakeScreenShot extends TestNG_Utility{
	...
	test.info("Username Entered");
		...
		driver.findElement(By.id("password")).sendKeys("sathyasampu12");
	test.info("Password Entered");
		waitExplicitly(10, driver.findElement(By.id("Login")));
		driver.findElement(By.id("Login")).click();
		
		test.addScreenCaptureFromPath(takeScreenShot());
		test.log(Status.PASS, "Login to salesforce failed");
